...
sub test_parse_events7 {
    my $test = shift;

    isa_ok my $clubracing = RennPoints::ClubRacing->new( content => scalar(read_file("test_files/clubracing/clubracing_7")) ), 'RennPoints::ClubRacing';

    is @{$clubracing->events}, 4, "Testing number of events that were parsed";
